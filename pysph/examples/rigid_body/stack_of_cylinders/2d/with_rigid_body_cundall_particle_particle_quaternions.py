...
from pysph.sph.rigid_body_cundall_2d import (
    ...
    get_particle_array_rigid_body_quaternion_cundall_2d_dem,
    RK2StepRigidBodyDEMCundallQuaternion)
...
class ZhangStackOfCylinders(Application):
    ...
    def create_particles(self):
        ...
        cylinders = get_particle_array_rigid_body_quaternion_cundall_2d_dem(
    ...
    def create_solver(self):
        ...
        integrator = EPECIntegratorMultiStage(
            cylinders=RK2StepRigidBodyDEMCundallQuaternion())
