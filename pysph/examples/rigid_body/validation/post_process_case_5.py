...
def post_process(case):
    ...
    # logfile = "case_5_rbrms_output/case_5.log"
    ...
    # iters = range(0, 100000, interval)
    # logfile = "case_5_rbqs_output/case_5.log"
    # files = get_files_at_given_times_from_log(files, iters, logfile)
    ...
    plt.legend()
    plt.savefig("case_5_ang_mom", dpi=300)
    plt.show()
    ...
    plt.legend()
    plt.savefig("case_5_lin_mom", dpi=300)
    plt.show()
    ...
    plt.savefig("case_5_energy", dpi=300)
    plt.show()
