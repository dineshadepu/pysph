...
class PotyondyIPForceStage1(Equation):
    ...
    def initialize(self, d_idx, d_bc_total_contacts, d_x, d_y, d_bc_ft_x,
        ...
        for i in range(p, q1):
            ...
            dtb2 = dt / 2.
            d_bc_ft_x[i] += - self.kt * vt_x * dtb2 - vt_x * 1000.
            d_bc_ft_y[i] += - self.kt * vt_y * dtb2 - vt_y * 1000.
...
class PotyondyIPForceStage2(Equation):
    ...
    def initialize(self, d_idx, d_bc_total_contacts, d_x, d_y, d_bc_ft_x,
        ...
        for i in range(p, q1):
            ...
            # get the incremental force
            d_bc_ft_x[i] = d_bc_ft0_x[i] - self.kt * vt_x * dt - vt_x * 1000.
            d_bc_ft_y[i] = d_bc_ft0_y[i] - self.kt * vt_y * dt - vt_y * 1000.
