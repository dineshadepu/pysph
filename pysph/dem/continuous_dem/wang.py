...
from math import sqrt, asin, sin, acos, log
import numpy as np
from pysph.sph.scheme import Scheme
from pysph.sph.equation import Group, MultiStageEquations
from pysph.sph.integrator import EulerIntegrator
from pysph.base.kernels import CubicSpline
from pysph.sph.quaternion import (q_inverse_vec_q, dot_product, cross_product,
                                  magnitude, quaternion_multiplication)
...
class PotyondyIPForceStage1(Equation):
    ...
    def _get_helpers_(self):
        return [q_inverse_vec_q, dot_product, cross_product, quaternion_multiplication]
    ...
    def initialize(self, d_idx, d_bc_total_contacts, d_x, d_y, d_z, d_bc_ft_x,
                   ...
                   d_q0, d_q1, d_q2, d_q3, d_qinv0, d_qinv1, d_qinv2, d_qinv3,
                   d_bc_x_t0, d_bc_y_t0, d_bc_z_t0, dt):
        ...
        for i in range(p, q1):
            ...
            # first compute h
            tmp = 0.5**0.5 *
            h[0] = one_root_2 * ((rc_magn + rc[2]) / 1)**0.5
