...
def analyse_tng_cnt_info_cundall(pa, idx):
    limit = pa.limit[0]
    print("ids of partticle {idx} in contact".format(idx=idx))
    print(pa.tng_idx[limit * idx:limit * idx + limit])
    print('tng_frc')
    print(pa.tng_frc[limit * idx:limit * idx + limit])
    print('tng_frc0')
    print(pa.tng_frc0[limit * idx:limit * idx + limit])
...
def analyse_tng_cnt_info_from_file(file_name, name, idx):
    ...
    spheres = analyse_tng_cnt_info_cundall(spheres, idx)
    return spheres
