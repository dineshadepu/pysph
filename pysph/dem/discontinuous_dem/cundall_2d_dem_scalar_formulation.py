...
class Cundall2dForceParticleParticleStage1(Equation):
    def __init__(self, dest, sources, kn=1e3, kt=1e2, mu=0.5, en=0.8):
        self.kn = kn
        self.kt = kt
        self.kt_1 = 1. / self.kt
        self.en = en
    ...
    def loop(self, d_idx, d_m, d_x, d_y, d_u, d_v, d_fx, d_fy, d_torz, d_wz,
             ...
             d_dem_id, d_free_cnt_limit, RIJ, d_rad_s, d_free_cnt_fn,
             d_free_cnt_ft, s_idx, s_m, s_rad_s, s_dem_id, s_wz, s_x, s_y, s_u,
             s_v, dt):
...
class Cundall2dForceParticleParticleStage2(Equation):
    ...
    def loop(self, d_idx, d_m, d_x, d_y, d_u, d_v, d_fx, d_fy, d_torz, d_wz,
             ...
             d_dem_id, d_free_cnt_limit, RIJ, d_rad_s, d_free_cnt_fn,
             d_free_cnt_ft, s_idx, s_m, s_rad_s, s_dem_id, s_wz, s_x, s_y, s_u,
             s_v, dt, d_free_cnt_fn0, d_free_cnt_ft0):
...
class UpdateFreeContactsWithParticles(Equation):
    def initialize_pair(self, d_idx, d_x, d_y, d_rad_s, d_total_no_free_cnt,
                        ...
                        d_free_cnt_idx_dem_id, d_free_cnt_fn,
                        d_free_cnt_ft, d_free_cnt_fn0, d_free_cnt_ft0, s_x,
                        s_y, s_rad_s, s_dem_id):
        p = declare('int')
        count = declare('int')
        k = declare('int')
